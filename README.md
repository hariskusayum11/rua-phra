...
- ภาพมีมิติและความลึก ทั้งการเคลื่อนไหวตามการเลื่อนหน้าและการเอียงตามเมาส์
...
## การเคลื่อนไหวและความลึก

เรือพระเป็นของขนาดใหญ่ปิดทองที่คนเดินรอบและแหงนมอง สี่เหลี่ยมแบน ๆ บนจอทำให้สิ่งนั้นหายไปหมด
หน้าเว็บจึงยืมวิธีทดแทนสองอย่าง คือชั้นภาพที่เลื่อนคนละความเร็วเวลาเลื่อนหน้า
และภาพที่เอียงเข้าหาเมาส์เหมือนเป็นวัตถุ ไม่ใช่รูป พร้อมแสงที่ไล่ไปบนภาพแบบแสงตกบนทอง

> **ไม่ใช่โมเดล 3D จริง** ทุกอย่างที่ขยับคือภาพถ่ายจริงจากพื้นที่ ไม่มีการสร้างเรือสามมิติ
> หรือวาดลายไทยประกอบขึ้นมาใหม่ การสร้างโมเดลเรือพระโดยไม่มีใครรังวัดของจริง
> คือการแต่งรูปทรงของงานช่างขึ้นเอง ซึ่งเป็นสิ่งที่คลังนี้ตั้งใจไม่ทำ

ทั้งหมดอยู่ใน `src/app/motion.css` ไฟล์เดียว อ่านไฟล์นี้จบจะรู้ว่ามีอะไรขยับบ้าง กติกาสองข้อ

1. **ใช้ได้แค่ `transform` กับ `opacity`** ห้ามเปลี่ยนขนาดหรือตำแหน่งในผัง
   เพราะหน้าแรกมี test บังคับว่า CLS ต้องต่ำกว่า 0.1
2. **ต้องผ่านสองด่านเสมอ** คือ `prefers-reduced-motion: no-preference`
   และ `@supports (animation-timeline: view())` เบราว์เซอร์ที่ไม่รองรับจะได้หน้าเดิมทุกประการ
   การเคลื่อนไหวเป็นส่วนเสริม ไม่ใช่เนื้อหา

ข้อควรระวังที่เจอระหว่างทางและแก้ไปแล้ว

- **ไม่เอียงปุ่มหรือตัวควบคุม** เดิมให้บล็อกวิดีโอวันชักพระเลื่อนตามแนวนอนตามจังหวะการลากเรือ
  ซึ่งตรงกับความหมายของงาน แต่ผิดหลักการใช้งาน เพราะผู้ใช้ต้องกดปุ่มเล่นที่กำลังเลื่อนอยู่
  ตอนนี้บล็อกวิดีโอแค่เคลื่อนเข้ามาแล้วหยุดนิ่ง
- **ไม่หรี่ความทึบของข้อความ** เดิมให้ชั้นความลึกเริ่มที่ `opacity: .25` ซึ่งทำให้ข้อความ
  ที่ยังไม่เลื่อนมาถึงมีค่า contrast 1.77:1 ตอนนี้ใช้การขยับตำแหน่งอย่างเดียว
- **จอสัมผัสไม่เอียง** นิ้วที่แตะอยู่บนภาพไม่ควรทำให้ภาพค้างเอียง

มี browser test ตรวจสามข้อ คือภาพเอียงตามเมาส์จริง เปิด reduced motion แล้วทุกภาพตั้งตรงสนิท
และไล่เลื่อนหน้าทีละช่วงเพื่อยืนยันว่าไม่มีอะไรทำให้หน้าเว็บกว้างเกินจอ
...
- การเคลื่อนไหว ทั้งการเอียงตามเมาส์ การปิดทั้งหมดเมื่อเปิด reduced motion และการไม่ล้นจอ
...
src/
  app/
    ...
    motion.css            ความลึกและการเคลื่อนไหวทั้งหมดของเว็บไซต์
  components/
    ...
    motion/               Scroll reveal และการเอียงภาพตามเมาส์
